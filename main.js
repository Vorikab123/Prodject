...
let btnCloseModel = document.querySelector('.window__edit_close');
let mainModal=document.querySelector('.main-modal')
// console.log(mainModal)
// console.log(inpEditCategory,inpEditDetails,inpEditPrice,inpEditQuantity,inpEditSales,inpEditUrl,btnEditAdd)
